...
/**
 * _strncmp - Write a function that compare two strings
 * @s1: the first string
...
/**
 * _close - Write a function that close a file descriptor
...
/**
 * elf_version - Write a function that print ELF version
 * @buffer: the ELF header
*/
void elf_version(const unsigned char *buffer)
{
...
/**
 * elf_osabi - Write a function that print ELF OS/ABI
 * @buffer: the ELF header
*/
void elf_osabi(const unsigned char *buffer)
{
...
/**
 * elf_abivers - Write a function that print ELF ABI version
 * @buffer: the ELF header
*/
void elf_abivers(const unsigned char *buffer)
{
...
/**
 * elf_type - Write a function that print ELF type
 * @buffer: the ELF header
...
/**
 * elf_entry - Write a function that  print entry point address
...
/**
 * main - Write a function that  copy a file's contents to another file
